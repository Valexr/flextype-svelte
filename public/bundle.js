...
var app = (function () {
    ...
    // (124:1) {#each navItems as navItem, i}
    function create_each_block$1(ctx) {
    	...
    	var block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "nav-item text-gray-100 hover:text-gray-600 " + /*navItem*/ ctx[3].class + " svelte-ec2ts8");
    			attr_dev(a, "data-tooltip", a_data_tooltip_value = /*navItem*/ ctx[3].name);
    			add_location(a, file$4, 124, 2, 5741);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(124:1) {#each navItems as navItem, i}",
    		ctx: ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	var block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", "nav-main svelte-ec2ts8");
    			add_location(nav, file$4, 122, 0, 5684);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
