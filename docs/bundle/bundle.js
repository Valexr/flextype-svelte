...
var app = (function () {
    ...
    // (30:1) {#each navItems as navItem, i}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "nav-item " + /*navItem*/ ctx[3].class + " svelte-2vnarf");
    			attr_dev(a, "data-tooltip", a_data_tooltip_value = /*navItem*/ ctx[3].name);
    			add_location(a, file$4, 30, 2, 1341);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:1) {#each navItems as navItem, i}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", nav_class_value = "nav " + /*customClass*/ ctx[0] + " svelte-2vnarf");
    			add_location(nav, file$4, 28, 0, 1275);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*customClass*/ 1 && nav_class_value !== (nav_class_value = "nav " + /*customClass*/ ctx[0] + " svelte-2vnarf")) {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["class", "flextype"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("flextype" in $$props) $$invalidate(2, flextype = $$props.flextype);
    	};

    	$$self.$capture_state = () => {
    		return { customClass, flextype, navItems };
    	};
    	...
    	return [customClass, navItems, flextype];
    }

    class Nav extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$6, safe_not_equal, { class: 0, flextype: 2 });
    ...
    /* src/components/Header.svelte generated by Svelte v3.18.2 */
    ...
    // (15:3) {#each headerTabs as headerTab, i}
    function create_each_block$2(ctx) {
    	let li;
    	let a;
    	let t0_value = /*headerTab*/ ctx[4].name + "";
    	let t0;
    	let a_class_value;
    	let a_href_value;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*headerTab*/ ctx[4].class) + " svelte-9m38iy"));
    			attr_dev(a, "href", a_href_value = /*headerTab*/ ctx[4].href);
    			add_location(a, file$5, 16, 5, 394);
    			attr_dev(li, "class", "svelte-9m38iy");
    			add_location(li, file$5, 15, 4, 384);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:3) {#each headerTabs as headerTab, i}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let each_value = /*headerTabs*/ ctx[1];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!default_slot) {
    				attr_dev(ul, "class", "header-tabs svelte-9m38iy");
    				add_location(ul, file$5, 13, 2, 317);
    			}

    			attr_dev(header, "class", header_class_value = "header " + /*customClass*/ ctx[0] + " svelte-9m38iy");
    			add_location(header, file$5, 11, 0, 269);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!default_slot) {
    				if (dirty & /*headerTabs*/ 2) {
    					each_value = /*headerTabs*/ ctx[1];
    					let i;
    			...
    			if (!current || dirty & /*customClass*/ 1 && header_class_value !== (header_class_value = "header " + /*customClass*/ ctx[0] + " svelte-9m38iy")) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let headerTabs = [
    		{ id: 0, name: "Entries", class: "active" },
    		{ id: 1, name: "Editor", class: "" },
    		{ id: 2, name: "Media", class: "" },
    		{ id: 3, name: "Source", class: "disable" }
    	];
    	...
    	$$self.$capture_state = () => {
    		return { customClass, headerTabs };
    	};

    	$$self.$inject_state = $$props => {
    		if ("customClass" in $$props) $$invalidate(0, customClass = $$props.customClass);
    		if ("headerTabs" in $$props) $$invalidate(1, headerTabs = $$props.headerTabs);
    	};

    	return [customClass, headerTabs, $$scope, $$slots];
    }
    ...
    // (36:14) {#each dropdownMenuItems as dropdownMenuItem, i}
    function create_each_block_1$1(ctx) {
    	...
    	const icon = new Icon({
    			props: {
    				data: /*dropdownMenuItem*/ ctx[5].icon,
    				class: "",
    				scale: "1"
    			},
    			$$inline: true
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", a_href_value = /*dropdownMenuItem*/ ctx[5].href);
    			attr_dev(a, "onclick", "");
    			attr_dev(a, "target", a_target_value = /*dropdownMenuItem*/ ctx[5].target);
    			attr_dev(a, "data-tooltip", a_data_tooltip_value = /*dropdownMenuItem*/ ctx[5].name);
    			add_location(a, file$6, 36, 16, 2196);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			mount_component(icon, a, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:14) {#each dropdownMenuItems as dropdownMenuItem, i}",
    		ctx
    	});
    ...
    // (27:6) {#each tableItems as tableItem, i}
    function create_each_block$3(ctx) {
    	...
    	let td1;
    	let a;
    	let t1_value = /*tableItem*/ ctx[2].name + "";
    	let t1;
    	let a_href_value;
    	let t2;
    	let td2;
    	...
    	let each_value_1 = /*dropdownMenuItems*/ ctx[0];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td0, file$6, 28, 12, 1839);
    			attr_dev(a, "href", a_href_value = /*tableItem*/ ctx[2].href);
    			add_location(a, file$6, 32, 14, 2006);
    			attr_dev(td1, "class", "px-4");
    			add_location(td1, file$6, 31, 12, 1974);
    			attr_dev(td2, "class", "px-4 text-right");
    			add_location(td2, file$6, 34, 12, 2088);
    			attr_dev(tr, "class", "border h-12 px-4 py-2 hover:bg-gray-300");
    			add_location(tr, file$6, 27, 8, 1774);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*dropdownMenuItems*/ 1) {
    				each_value_1 = /*dropdownMenuItems*/ ctx[0];
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:6) {#each tableItems as tableItem, i}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	let tbody;
    	let current;
    	let each_value = /*tableItems*/ ctx[1];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tbody, file$6, 25, 4, 1717);
    			attr_dev(table, "class", "table table-auto no-margin w-full overflow-auto");
    			add_location(table, file$6, 24, 0, 1649);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*dropdownMenuItems, tableItems*/ 3) {
    				each_value = /*tableItems*/ ctx[1];
    				let i;
    ...
    function instance$7($$self) {
    	let dropdownMenuItems = [
    		{
    			...
    			name: "Edit",
    			icon: faEdit,
    			href: "/admin/entries/edit?id=team-members/scott-jy&amp;type=editor"
    		},
    		{
    			id: 1,
    			class: "",
    			name: "Add",
    			icon: faPlusCircle,
    			href: "/admin/entries/add?id=team-members/scott-jy"
    		},
    		{
    			id: 2,
    			class: "",
    		...
    		},
    		{
    			...
    			name: "Rename",
    			icon: faFont,
    			href: "/admin/entries/rename?id=team-members/scott-jy"
    		},
    		{
    			id: 4,
    			class: "",
    			...
    			href: "/admin/entries/move?id=team-members/scott-jy"
    		},
    		{
    			id: 5,
    			class: "",
    			name: "Preview",
    			icon: faEye,
    			href: "http://flextype.local.web/team-members/scott-jy",
    			target: "_blank"
    		},
    		{
    			id: 6,
    			...
    			name: "Type",
    			icon: faListAlt$1,
    			href: "/admin/entries/type?id=team-members/scott-jy"
    		},
    		{
    			id: 7,
    			class: "",
    	...
    	$$self.$inject_state = $$props => {
    		if ("dropdownMenuItems" in $$props) $$invalidate(0, dropdownMenuItems = $$props.dropdownMenuItems);
    		if ("tableItems" in $$props) $$invalidate(1, tableItems = $$props.tableItems);
    	};

    	return [dropdownMenuItems, tableItems];
    }
    ...
    /* src/components/FlextypeSvg.svelte generated by Svelte v3.18.2 */

    const file$7 = "src/components/FlextypeSvg.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "cx", "90");
    			attr_dev(circle, "cy", "90");
    			attr_dev(circle, "r", "90");
    			add_location(circle, file$7, 12, 1, 354);
    			attr_dev(path, "fill", "white");
    			attr_dev(path, "d", "M65.463 46.035l-11.331 90.53 34.425-.028 4.551-34.314 21.282.177 2.993-21.381-21.915-.168 1.158-9.19 28.094-.046 3.299-25.856-62.556.276z");
    			add_location(path, file$7, 13, 1, 401);
    			attr_dev(svg, "width", /*size*/ ctx[0]);
    			attr_dev(svg, "height", /*size*/ ctx[0]);
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "viewBox", "0 0 180 180");
    			attr_dev(svg, "class", svg_class_value = "flextype " + /*customClass*/ ctx[1]);
    			add_location(svg, file$7, 11, 0, 255);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*customClass*/ 2 && svg_class_value !== (svg_class_value = "flextype " + /*customClass*/ ctx[1])) {
    				attr_dev(svg, "class", svg_class_value);
    			}
    		},
    		i: noop,
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<FlextypeSvg> was created with unknown prop '${key}'`);
    	});
    ...
    class FlextypeSvg extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$9, safe_not_equal, { size: 0, class: 1 });
    	...
    	get size() {
    		throw new Error("<FlextypeSvg>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set size(value) {
    		throw new Error("<FlextypeSvg>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/components/Html5.svelte generated by Svelte v3.18.2 */

    const file$8 = "src/components/Html5.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "fill", "#E34F26");
    			attr_dev(path0, "d", "M71,460 L30,0 481,0 440,460 255,512");
    			add_location(path0, file$8, 1, 1, 54);
    			attr_dev(path1, "fill", "#EF652A");
    			attr_dev(path1, "d", "M256,472 L405,431 440,37 256,37");
    			add_location(path1, file$8, 1, 63, 116);
    			attr_dev(path2, "fill", "#EBEBEB");
    			attr_dev(path2, "d", "M256,208 L181,208 176,150 256,150 256,94 255,94 114,94 115,109 129,265 256,265zM256,355 L255,355 192,338 188,293 158,293 132,293 139,382 255,414 256,414z");
    			add_location(path2, file$8, 1, 121, 174);
    			attr_dev(path3, "fill", "#FFF");
    			attr_dev(path3, "d", "M255,208 L255,265 325,265 318,338 255,355 255,414 371,382 372,372 385,223 387,208 371,208zM255,94 L255,129 255,150 255,150 392,150 392,150 392,150 393,138 396,109 397,94z");
    			add_location(path3, file$8, 1, 301, 354);
    			attr_dev(svg, "width", "180");
    			attr_dev(svg, "height", "180");
    ...
    function create_fragment$b(ctx) {
    	...
    	const nav = new Nav({ props: { class: "" }, $$inline: true });
    	const header = new Header({ props: { class: "" }, $$inline: true });
    	const table = new Table({ $$inline: true });
    	const flextypesvg = new FlextypeSvg({ props: { size: "180" }, $$inline: true });
    	const html5 = new Html5({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(flextypesvg.$$.fragment);
    			t4 = space();
    			create_component(html5.$$.fragment);
    			t5 = space();
    			svg = svg_element("svg");
    			use = svg_element("use");
    			xlink_attr(use, "xlink:href", "feather-sprite.svg#activity");
    			add_location(use, file$9, 33, 7, 535);
    			attr_dev(svg, "class", "svg-ico svelte-16d624l");
    			...
    			add_location(svg, file$9, 24, 6, 346);
    			attr_dev(main, "class", "main svelte-16d624l");
    			add_location(main, file$9, 19, 2, 263);
    			attr_dev(div0, "class", "content svelte-16d624l");
    			add_location(div0, file$9, 16, 1, 216);
    			attr_dev(div1, "class", "base svelte-16d624l");
    			add_location(div1, file$9, 13, 0, 177);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t3);
    			mount_component(flextypesvg, main, null);
    			append_dev(main, t4);
    			mount_component(html5, main, null);
    			append_dev(main, t5);
    			append_dev(main, svg);
    			append_dev(svg, use);
    			current = true;
    		...
    		i: function intro(local) {
    			...
    			transition_in(flextypesvg.$$.fragment, local);
    			transition_in(html5.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(flextypesvg.$$.fragment, local);
    			transition_out(html5.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(flextypesvg);
    			destroy_component(html5);
    		}
    	};
