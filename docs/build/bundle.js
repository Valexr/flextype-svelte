...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "nav-item " + /*navItem*/ ctx[3].class + " svelte-vvl3iy");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(nav, "class", nav_class_value = "nav " + /*customClass*/ ctx[0] + " svelte-vvl3iy");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*customClass*/ 1 && nav_class_value !== (nav_class_value = "nav " + /*customClass*/ ctx[0] + " svelte-vvl3iy")) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*headerTab*/ ctx[4].class) + " svelte-ge278l"));
    			attr_dev(a, "href", a_href_value = /*headerTab*/ ctx[4].href);
    			add_location(a, file$5, 16, 5, 394);
    			attr_dev(li, "class", "svelte-ge278l");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!default_slot) {
    				attr_dev(ul, "class", "header-tabs svelte-ge278l");
    				add_location(ul, file$5, 13, 2, 317);
    			}

    			attr_dev(header, "class", header_class_value = "header " + /*customClass*/ ctx[0] + " svelte-ge278l");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*customClass*/ 1 && header_class_value !== (header_class_value = "header " + /*customClass*/ ctx[0] + " svelte-ge278l")) {
    ...
    // (51:16) {#each dropdownMenuItems as dropdownMenuItem, i}
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(icon.$$.fragment);
    			t = space();
    			attr_dev(a, "class", "dropdown-item svelte-13xncrm");
    			...
    			add_location(a, file$6, 51, 20, 2915);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			mount_component(icon, a, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(51:16) {#each dropdownMenuItems as dropdownMenuItem, i}",
    		ctx
    	});
    ...
    // (35:6) {#each tableItems as tableItem, i}
    function create_each_block$3(ctx) {
    	...
    	let td2;
    	let a1;
    	let t3_value = /*tableItem*/ ctx[2].created + "";
    	let t3;
    	let a1_href_value;
    	let t4;
    	let td3;
    	let a2;
    	let t5_value = /*tableItem*/ ctx[2].updated + "";
    	let t5;
    	let a2_href_value;
    	let t6;
    	let td4;
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			attr_dev(td0, "class", "entry-icon svelte-13xncrm");
    			add_location(td0, file$6, 36, 12, 2229);
    			attr_dev(a0, "href", a0_href_value = /*tableItem*/ ctx[2].href);
    			attr_dev(a0, "class", "svelte-13xncrm");
    			add_location(a0, file$6, 40, 16, 2405);
    			attr_dev(td1, "class", "entry-name svelte-13xncrm");
    			add_location(td1, file$6, 39, 12, 2365);
    			attr_dev(a1, "href", a1_href_value = /*tableItem*/ ctx[2].href);
    			add_location(a1, file$6, 43, 16, 2542);
    			attr_dev(td2, "class", "entry-created text-center");
    			add_location(td2, file$6, 42, 12, 2487);
    			attr_dev(a2, "href", a2_href_value = /*tableItem*/ ctx[2].href);
    			add_location(a2, file$6, 46, 16, 2682);
    			attr_dev(td3, "class", "entry-updated text-center");
    			add_location(td3, file$6, 45, 12, 2627);
    			attr_dev(nav, "class", "dropdown svelte-13xncrm");
    			add_location(nav, file$6, 49, 16, 2807);
    			attr_dev(td4, "class", "entry-menu svelte-13xncrm");
    			add_location(td4, file$6, 48, 12, 2767);
    			attr_dev(tr, "class", "entry svelte-13xncrm");
    			add_location(tr, file$6, 35, 8, 2198);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:6) {#each tableItems as tableItem, i}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			tr = element("tr");
    			th0 = element("th");
    			th0.textContent = "Icon";
    			t1 = space();
    			th1 = element("th");
    			th1.textContent = "Name";
    			t3 = space();
    			th2 = element("th");
    			th2.textContent = "Created";
    			t5 = space();
    			th3 = element("th");
    			th3.textContent = "Updated";
    			t7 = space();
    			th4 = element("th");
    			th4.textContent = "Menu";
    			t9 = space();
    			tbody = element("tbody");
    			...
    			attr_dev(th0, "class", "px-4 py-2 text-gray-800");
    			add_location(th0, file$6, 26, 12, 1816);
    			attr_dev(th1, "class", "px-4 py-2 text-gray-800 text-left");
    			add_location(th1, file$6, 27, 12, 1874);
    			attr_dev(th2, "class", "px-4 py-2 text-gray-800");
    			add_location(th2, file$6, 28, 12, 1942);
    			attr_dev(th3, "class", "px-4 py-2 text-gray-800");
    			add_location(th3, file$6, 29, 12, 2003);
    			attr_dev(th4, "class", "px-4 py-2 text-gray-800");
    			add_location(th4, file$6, 30, 12, 2064);
    			add_location(tr, file$6, 25, 8, 1799);
    			add_location(thead, file$6, 24, 4, 1783);
    			add_location(tbody, file$6, 33, 4, 2141);
    			attr_dev(table, "class", "table table-auto no-margin w-full overflow-auto");
    			add_location(table, file$6, 23, 0, 1715);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$7, 45, 4, 930);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$7, 36, 3, 696);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			h2 = element("h2");
    			h2.textContent = "entry.on_this_page.title";
    			t1 = space();
    			a = element("a");
    			a.textContent = "entry.on_this_page.link";
    			t3 = space();
    			add_location(h2, file$7, 39, 6, 749);
    			attr_dev(a, "href", "entry.on_this_page.title");
    			attr_dev(a, "alt", "entry.on_this_page.title");
    			add_location(a, file$7, 40, 6, 789);
    			add_location(li, file$7, 38, 5, 738);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, h2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:4) {#each entries as entry, i}",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*entries*/ ctx[0]) return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			if_block.c();
    			attr_dev(main, "class", "main svelte-77k8ic");
    			add_location(main, file$7, 28, 2, 485);
    			attr_dev(div0, "class", "content svelte-77k8ic");
    			add_location(div0, file$7, 25, 1, 438);
    			attr_dev(div1, "class", "base svelte-77k8ic");
    			add_location(div1, file$7, 22, 0, 399);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
